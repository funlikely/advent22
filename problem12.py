...
def main_problem_12_1(lines, debug_and_log):
    return 0


def read_input_file():
    file = open("data/problem12.txt")
...
def main_problem_12_2(lines, debug_and_log):
    return 0


def main():
    input_file_lines = read_input_file()
    problem_answer = main_problem_12_1(input_file_lines, True)
    print(f"ANSWER TO PROBLEM 12.1, level of monkey business = {problem_answer}")
    problem_answer = main_problem_12_2(input_file_lines, True)
    print(f"ANSWER TO PROBLEM 12.2, level of monkey business = {problem_answer}")
